...
class ItemValidationTest(FunctionalTest):
    ...
    def test_cannot_add_empty_list_items(self):
        ...
        self.browser.find_element_by_id('id_new_item').send_keys('Pet granola\n')
        ...
        self.check_for_row_in_list_table('Pet granola')
        error = self.browser.find_element_by_css_selector('.has-error')
        self.assertEqual(error.text, "You can't have an empty list item")
        
        # and he fixes it by adding some text
        self.browser.find_element_by_id('id_new_item').send_keys('Charlie roll\n')
        self.check_for_row_in_list_table('1: Pet granola')
